...
const Main = () => {
  ...
  return (
    <div className="relative w-full">
      <section className="relative min-h-screen pt-16 md:pt-20 flex items-center bg-[#2c2c2e]">
        <motion.div
      ...
      {/* Skills Section */}
      <section className="py-16 md:py-20 bg-[#232325]">
        <motion.div
      ...
      {/* Education Section */}
      {/* Education Section with Side-by-Side Layout */}
      <section className="py-16 md:py-20">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
            ...
            <motion.div
              className="bg-[#2c2c2e] rounded-xl border border-gray-700 p-4 md:p-6 h-full flex flex-col"
            ...
            >
              ...
              <div className="mt-4 flex-grow">
                ...
                <ul className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-2 text-gray-400">
      ...
      <section className="py-16 md:py-20">
        ...
        >
          <div className="max-w-2xl mx-auto text-center">
            ...
            <motion.p className="text-gray-300 mb-4" variants={fadeInUp}>
              I&apos;m always eager to learn and collaborate on new projects.
            </motion.p>
            <motion.div
              className="flex items-center justify-center space-x-2 text-base md:text-lg text-gray-300"
              variants={fadeInUp}
              whileHover={{ scale: 1.05 }}
            >
...
const SkillCard: React.FC<SkillCardProps> = ({
  ...
  <motion.div
    className="p-4 md:p-6 bg-[#2c2c2e] rounded-xl border border-gray-700 hover:border-blue-500 transition-all"
    initial={{ opacity: 0, y: 20 }}
    whileInView={{ opacity: 1, y: 0 }}
    viewport={{ once: true }}
  ...
  >
    <motion.div
      className="w-10 h-10 md:w-12 md:h-12 bg-blue-500/10 rounded-lg flex items-center justify-center mb-4"
